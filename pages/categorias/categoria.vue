...
export default {
  ...
  async asyncData({ store }) {
    return {
      categories: await store.dispatch('categorias/getCategories')
  ...
  methods: {
    deleteCategory(id) {
      this.$store.dispatch('categorias/deleteCategory', id)
        .then(() => {
    ...
    updateCategory(category) {
      ...
      this.$store.dispatch('categorias/updateCategory', { id: category.id, data })
        .then(() => {
    ...
    addCategory() {
      ...
      this.$store.dispatch('categorias/addCategory', data)
        .then((response) => {
